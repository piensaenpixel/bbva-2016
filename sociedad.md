...
<section class="principal u-txt-center bg-interior bg-interior--sociedad">
...
<section class="section section--small">
  <div class="container container--small">
    <h2 class="u-txt-center title-section title-section--inside">Inversiones en programas sociales</h2>
    ...
    <ul class="list list--threeItems">
      <li class="list-item">
        ...
        <svg width="41px" height="34px" viewBox="173 -1534 41 34" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <path d="M180.454545,-1514.73333 L180.454545,-1507.17778 L193.5,-1500 L206.545455,-1507.17778 L206.545455,-1514.73333 L193.5,-1507.55556 L180.454545,-1514.73333 Z M193.5,-1534 L173,-1522.66667 L193.5,-1511.33333 L210.272727,-1520.58889 L210.272727,-1507.55556 L214,-1507.55556 L214,-1522.66667 L193.5,-1534 Z" id="Shape" stroke="none" fill="#0085D3" fill-rule="evenodd"></path>
        </svg>
        <h4 class="tit-block">Educación financiera</h4>
      ...
      <li class="list-item">
        <svg width="28px" height="30px" viewBox="438 -1530 28 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <g id="Group" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(438.000000, -1530.000000)">
              <path d="M14,14 C17.9666667,14 21,10.9666667 21,7 C21,3.03333333 17.9666667,0 14,0 C10.0333333,0 7,3.03333333 7,7 C7,10.9666667 10.0333333,14 14,14 Z" id="Shape" fill="#0085D3"></path>
              <path d="M14,14 C6,14 0,19.4 0,24 L0,30 L28,30 L28,24 C28,19.4 22,14 14,14 Z" id="Path" fill="#0085D3"></path>
          </g>
        </svg>
        <h4 class="tit-block">Emprendimiento social</h4>
        <p class="paragraph">tiene como objeto apoyar a emprendedores con menos oportunidades y a aquellos que generan un impacto social positivo a través de sus empresas.</p>
      </li>
      <li class="list-item">
        <svg width="28px" height="30px" viewBox="438 -1530 28 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <g id="Group" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(438.000000, -1530.000000)">
        ...
        <h4 class="tit-block">Conocimiento</h4>
    ...
    <p class="link-more">
      <a href="#">
        <svg width="12px" height="12px" viewBox="496 -279 12 12" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <path d="M502,-279 C498.7,-279 496,-276.3 496,-273 C496,-269.7 498.7,-267 502,-267 C505.3,-267 508,-269.7 508,-273 C508,-276.3 505.3,-279 502,-279 Z M505,-272.4 L502.6,-272.4 L502.6,-270 L501.4,-270 L501.4,-272.4 L499,-272.4 L499,-273.6 L501.4,-273.6 L501.4,-276 L502.6,-276 L502.6,-273.6 L505,-273.6 L505,-272.4 Z" id="Shape" stroke="none" class="icon-more" fill-rule="evenodd"></path>
        </svg>
        Saber más
      </a>
    </p>
...
<section class="section section--small section--grey">
  <div class="container container--small">
    <h2 class="subtitle-section subtitle-section--small">Iniciativas sociales</h2>

    <div class="progress">
      <div class="progress-header">
        <p class="progress-start">2.562<small>MM</small></p>
        <p class="progress-end">XXX BENEFICIO ATRIBUIDO</p>
      </div>
    ...
    <p class="paragraph">
      En 2016 hemos destinado más de xxx millones de euros a iniciativas sociales.<br/>
      Esta cifra representa el xx% del beneficio atribuido del Grupo en este ejercicio.
    </p>
...
<section class="section section--small section--blue">
  <div class="container container--small">
    ...
    <p class="paragraph">
    Nuestro objetivo global es impulsar un concepto de educación financiera, basado en la adquisición de conocimientos, habilidades, actitudes y comportamientos con el fin de lograr un conocimiento de conceptos financieros y un cambio de comportamiento en la toma de decisiones financieras</p>
    <ul class="list-numbers list-numbers--simple">
      <li class="list-numbersItem">
        <h3>Plan Global de Educación Financiera <span>(desde 2008)</span></h3>
        <ul class="list">
          <li class="list-item">
            <h4>Inversión</h4>
            <p class="number">724.627</p>
          </li>
          <li class="list-item">
            <h4>Personas beneficiadas</h4>
            <p class="number">55.981</p>
          </li>
        </ul>
      </li>
    </ul>
...
<section class="section section--small">
  <div class="container container--small">
    ...
    <p class="paragraph">Programas aislados de apoyo al emprendimiento se agrupan en una única línea de actuación y toman  relevancia como parte fundamental del Plan de Inversión en la Comunidad para el periodo 2016-2018.</p>
    <p class="paragraph">BBVA quiere apoyar a los emprendedores que cambian vidas y pone el foco en los emprendores vulnerables, a los que apoya a través de la Fundación Microfinanzas BBVA, y en los emprendedores que crean alto impacto social a través de sus empresas, cuyo crecimiento se impulsa a través del programa  BBVA Momentum.</p>
    <p class="link-more">
      <a href="#">
        <svg width="12px" height="12px" viewBox="496 -279 12 12" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <path d="M502,-279 C498.7,-279 496,-276.3 496,-273 C496,-269.7 498.7,-267 502,-267 C505.3,-267 508,-269.7 508,-273 C508,-276.3 505.3,-279 502,-279 Z M505,-272.4 L502.6,-272.4 L502.6,-270 L501.4,-270 L501.4,-272.4 L499,-272.4 L499,-273.6 L501.4,-273.6 L501.4,-276 L502.6,-276 L502.6,-273.6 L505,-273.6 L505,-272.4 Z" id="Shape" stroke="none" class="icon-more" fill-rule="evenodd"></path>
...
<section class="section section--small section--grey">
  <div class="container container--small">
    <h2 class="u-txt-center title-section title-section--inside">Conocimiento y cultura</h2>
    ...
    <h4 class="u-txt-center subheader-section u-upperCase">Esta línea estratégica incluye la actividad de</h4>
  </div>
</section>

<section class="section section--small">
  <div class="container container--small">
    <h2 class="u-txt-center title-section title-section--inside">Transparencia fiscal</h2>
    <h3 class="u-txt-center subtitle-section">Mayor transparencia en su responsabilidad fiscal</h3>
    <p class="paragraph">En 2015, el Consejo de Administración de BBVA acordó la aprobación de los “Principios corporativos en materia tributaria y estrategia fiscal”. Esta Estrategia se enmarca dentro del sistema de gobierno corporativo de BBVA y establece las políticas, principios y valores que deben guiar el comportamiento del Grupo en materia tributaria.</p>
    <p class="paragraph">El efectivo cumplimiento de los establecido por la estrategia fiscal es debidamente monitorizado y supervisado por los órganos de gobierno de BBVA.</p>
    <h4 class="u-txt-center subheader-section u-upperCase">La estrategia fiscal de BBVA se articula sobre los siguientes puntos básicos</h4>

    <ul class="list list--twoItems">
      <li class="list-item">
        <div class="icon-margin">
          <svg width="14px" height="15px" viewBox="0 0 14 15" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <path d="M8.22373675,1.76470588 L7.87379051,0 L0,0 L0,15 L1.74973122,15 L1.74973122,8.82352941 L6.64897865,8.82352941 L6.9989249,10.5882353 L13.1229842,10.5882353 L13.1229842,1.76470588 L8.22373675,1.76470588 Z M1.87202375,3.75432526 L5.93920945,7.82151096 L1.8600084,7.82151096 L1.87202375,3.75432526 Z" id="Combined-Shape" stroke="none" fill="#0085D3" fill-rule="evenodd"></path>
          </svg>
        </div>
        <p class="paragraph">dirigida a promover la formación en habilidades financieras, que permitan a las personas tomar decisiones informadas.</p>
      </li>
      <li class="list-item">
        <div class="icon-margin">
          <svg width="21px" height="15px" viewBox="39 0 21 15" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <g id="Group-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(39.000000, 0.000000)">
                  <polygon id="Path-3" fill="#0085D3" points="0 0 20.5060967 0 17.5 3 0 3"></polygon>
                  <polygon id="Path-3-Copy" fill="#0085D3" points="0 6 16.5060967 6 13.5 9 0 9"></polygon>
                  <polygon id="Path-3-Copy-2" fill="#0085D3" points="0 12 13.5060967 12 10.5 15 0 15"></polygon>
              </g>
          </svg>
        </div>
        <p class="paragraph">tiene como objeto apoyar a emprendedores con menos oportunidades y a aquellos que generan un impacto social positivo a través de sus empresas.</p>
