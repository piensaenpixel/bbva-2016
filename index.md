...
<section class="section section--estrategia">
  <div class="container u-txt-center">
    <h2 class="title-section">Estrategia</h2>
    <h3>Creando Oportunidades</h3>
    <p>Durante 2016, el Grupo BBVA ha realizado avances significativos en su Transformation Journey. Se ha reforzado la nueva estrategia de la Entidad, con especial foto en la digitalización y la experiencia de cliente, se ha relizado una simplificación de la estructura organizativa y se ha redefinido el nuevo tagline del Banco: "Creando Oportunidades".</p>
    <a href="#">Ver más</a>
  </div>
</section>
...
<section class="section">
  <div class="container">
    <h2 class="title-section u-txt-center">Nuestros principales puntos de interés</h2>
