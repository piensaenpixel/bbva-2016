...
<section class="section section--blue">
  <div class="container container--small">
    ...
    <ul class="list list--twoItems">
      ...
      <li class="list-item list-purpose">
        <h3 class="paragraph"><b>Alineado con nuestra visión de futuro</b></h3>
    ...
    <p class="paragraph no-margin u-txt-center is-l">Somos BBVA. Somos creadores de oportunidades</p> 
  </div>
</section>
