...
<section class="section section--blue section--blueDark">
  <div class="container container--small">
    ...
    <ul class="tabs is-blue">
      <li class="tabs-item"><a href="#resultados" class="is-active">Resultados</a></li>
      <li class="tabs-item"><a href="#balance">Balance y actividad</a></li>
      <li class="tabs-item"><a href="#rentabilidad">Rentabilidad/Eficiencia</a></li>
      <li class="tabs-item"><a href="#riesgo">Gestión del riesgo</a></li>
      <li class="tabs-item"><a href="#solvencia">Solvencia</a></li>
    </ul>
...
<section class="section section--grey">
  <div class="container container--small">
    ...
    <ul class="tabs">
      <li class="tabs-item"><a href="#riqueza" class="is-active">Generación
de riqueza</a></li>
...
1.043 Mill. € de remuneración en efectivo</p>
          ...
          <li class="list-item">
            ...
            <h4 class="txt-number is-small">9.440 <small>Mill. €</small></h4>
          ...
          <li class="list-item">
            ...
            <h4 class="txt-number is-small">24.692 <small>Mill. €</small></h4>
      ...
      <div class="tabs-item" id="desarrollo">
        ...
        <ul class="list list--threeItems u-txt-center">
          ...
          <li class="list-item">
            ...
            <p class="paragraph is-small">destinados a la <b>financiación de viviendas</b></p>
          </li>
          <li class="list-item">
            <h4 class="txt-number is-small">33.418 <small>Mill. €</small></h4>
            <p class="paragraph is-small">gestionados en <b>planes de pensiones</b></p>
          </li>
          <li class="list-item">
            <h4 class="txt-number is-small">2,5 <small>Millones</small></h4>
            <p class="paragraph is-small">de <b>pymes, microempresas y autónomos</b> apoyados o financiados por BBVA</p>
          </li>
          <li class="list-item">
            <h4 class="txt-number is-small">9,8 <small>Millones</small></h4>
            <p class="paragraph is-small">de personas favorecidas por
la <b>inclusión financiera</b></p>
          </li>
          <li class="list-item">
            <h4 class="txt-number is-small">1,8 <small>Millones</small></h4>
            <p class="paragraph is-small">de <b>microemprendedores</b> apoyados o financiados por la Fundación Microfinanzas BBVA con 1.009 Mill. €</p>
          </li>
        </ul>
      </div>
      ...
      <div class="tabs-item" id="sostenible">
        ...
        <ul class="list list--threeItems u-txt-center u-hcenter">
          ...
          <li class="list-item">
            ...
            5,02%</h4>
            <p class="paragraph is-small">de reducción de <b>consumo de agua</b> por persona</p>
          </li>
          <li class="list-item">
            <h4 class="txt-number is-small u-flex u-alignCenter u-hcenter">
            ...
            5.350 <small>Mill. €</small>
            </h4>
            <p class="paragraph is-small">de <b>colocación de
            emisiones</b> de bonos
verdes y sociales</p>
          </li>
          <li class="list-item">
            <h4 class="txt-number is-small u-flex u-alignCenter u-hcenter">
              ...
              4.444 <small>Mill. €</small>
            </h4>
            <p class="paragraph is-small">de financiación de operaciones
de <b>energías renovables</b></p>
          </li>
          <li class="list-item">
            <h4 class="txt-number is-small u-flex u-alignCenter u-hcenter">
            ...
            <p class="paragraph is-small">de la plantilla trabaja en
<b>edificios con certificación ambiental</b></p>
          </li>
        </ul>
